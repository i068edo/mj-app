  ...
  return (
    <div >
      ...
      <p><b style={{ color: '#0000FF' }}>平和（ピンフ）</b><br />
        <img src="images/pinfu.jpg" alt="ピンフ" />
      </p>
      ...
      <p><strong style={{ color: '#0000FF' }}>七対子（チートイツ/チートイ）</strong><br />
        <img src="images/ti-toi.jpg" alt="チートイツ" /><br />
      ...
      <p>
        ...
        <img src="images/tinitu.jpg" alt="チンイツ" /><br />
      ...
      <p>
        ...
        <img src="images/su-anko.jpg" alt="スーアンコー1" /><br />
      ...
      <p>
        ...
        <img src="images/su-si-ho1.jpg" alt="スーシーホー1" /><br />
        <img src="images/su-si-ho2.jpg" alt="スーシーホー2" /><br />
        風牌の４組を刻子にするか、３組を刻子にして残り１組を雀頭にしたものです。
      </p><br />

      <p>
        <strong style={{ color: '#0000FF' }}>清老頭（チンロートウ）</strong><br />
        <img src="images/tinro-to.jpg" alt="チンロートウ" /><br />
        １と９の牌を刻子にしたあがり。
      </p><br />

      <p>
        <strong style={{ color: '#0000FF' }}>国士無双（コクシムソウ）</strong><br />
        <img src="images/kokusi1.jpg" alt="コクシムソウ1" /><br />
        <img src="images/kokusi2.jpg" alt="コクシムソウ2" /><br />
